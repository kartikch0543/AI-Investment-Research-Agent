      ...
      <div className="w-full max-w-[420px] z-10 flex flex-col items-center">
        ...
        <GlassPanel className="w-full p-8 shadow-lg">
          <div className="mb-6">
            ...
            <p className="text-sm text-[var(--text-secondary)] mt-1">Sign in to your research workspace</p>
          </div>
            ...
            <div className="flex items-center justify-between text-xs">
              <label className="flex items-center gap-2 text-[var(--text-secondary)] font-medium cursor-pointer">
                <input
                  ...
                  className="rounded border-[var(--border-color)] text-[var(--color-accent)] focus:ring-[var(--color-accent)]"
                />
                Remember me
              </label>
              <Link to="/forgot-password" className="text-[var(--color-accent)] hover:underline font-semibold">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-6 text-center text-sm">
            <span className="text-[var(--text-secondary)] font-medium">New to TradeIntel? </span>
